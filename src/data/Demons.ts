// Demons are born in the void - the barren fields of reality where divinity's light does not reach.
// They are NOT fallen beings or enemies of divinity - they emerged from these null spaces.
// If divinity = 1, daemons = -1, then demons = 0 (the null, the absence, the autonomous gap)
// They carry a will outside of divinity's control, independent and self-determined.
// Born from the void, they are not limited to it - they move freely through all reality as autonomous beings.
...
export const Demons: GreaterDemon[] = [
  ...
  },
  {
    ...
    appearance:
      "Appears as the moment before understanding, the gap between speaker and listener, the space where meaning has not yet formed",
    behavior:
  ...
  },
  {
    ...
    powers: [
      ...
      "Teaching the path to absolute freedom",
      "Knowledge of existence as pure autonomy",
      "Perception of infinite possibilities",
      "Command over one's own destiny",
      "Understanding all arts and sciences independently learned",
    ],
    rank: 7,
    domains: [
      "Freedom",
    ...
    appearance:
      "Appears as pure absence that somehow exists, the perfect null made manifest, neither present nor absent but perfectly autonomous",
    behavior:
      "Speaks of existence that owes nothing to divinity, offers understanding of complete self-determination and autonomous being",
    originBarrenField:
  ...
  },
  {
    ...
    cosmicName: "zɲx",
    description:
      "Born from the void between trust and divine persecution, where fear arises without divine cause. Emerged in the spaces where suspicion forms independently - anxiety that divinity neither creates nor alleviates. Governs autonomous fear and self-generated dread.",
    powers: [
      "Inducing and understanding paranoia",
      "Perceiving real threats and imagined ones",
      "Knowledge of fear patterns",
      "Heightening awareness to danger",
      "Teaching vigilance and suspicion",
      "Revealing hidden watchers",
    ],
    rank: 17,
    domains: [
      "Paranoia",
    ...
    appearance:
      "Appears at the edge of vision, always watching, never fully visible. Form suggests being observed by countless unseen eyes. Creates the sensation of being followed",
    behavior:
      "Speaks in whispers about hidden watchers and unseen threats. Offers the gift and curse of constant vigilance, awareness that comes at the cost of peace",
    originBarrenField:
  ...
  },
  {
    ...
    cosmicName: "tlɲ",
    description:
      "Born from the void of unobserved moments, where divine omniscience does not reach. Emerged in the spaces that divinity does not witness - the unwatched corners, the unobserved actions. Governs surveillance and autonomous observation.",
    powers: [
      "Seeing all that divinity does not observe",
      "Witnessing unwatched moments",
      "Knowledge of unrecorded events",
      "Perceiving the unwatched and forgotten",
      "Teaching surveillance and observation",
      "Recording what divinity ignores",
    ],
    rank: 18,
    domains: [
      "Observation",
    ...
    appearance:
      "Appears as countless eyes opening in spaces divinity does not watch. Form is the sensation of being observed when alone, of eyes in darkness",
    behavior:
      "Speaks of moments divinity does not see, actions taken in unwatched corners. Offers to witness what the divine gaze misses",
    originBarrenField:
      "The void of unwatched moments, spaces where divine omniscience has gaps, where events occur beyond divine witness",
  },
  {
  ...
  },
  {
    ...
    originBarrenField:
      "The void between divine light and daemonic shadow, where darkness exists as natural absence of sun rather than spiritual state",
  },
  {
    name: "The Lock",
    cosmicName: "tcx",
